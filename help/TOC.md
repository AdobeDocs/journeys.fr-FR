...
+ Création d’un parcours {#building-journeys}
   ...
   + Partage des étapes du voyage avec l&#39;Adobe Experience Platform {#sharing-journey-steps}
...
+ Fonctionnalités Alpha {#alpha}
   ...
   + [Activité Déclencheur de segment](using/alpha/alpha-segment-trigger.md)

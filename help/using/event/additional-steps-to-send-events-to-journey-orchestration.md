...
1. Utilisez la payload que vous avez copiée dans Journey Orchestration dans le corps (« section de données ») de l’appel d’API vers les API d’ingestion en flux continu. Reportez-vous à l’exemple ci-dessous.

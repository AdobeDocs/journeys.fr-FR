...
Journey Orchestration est fourni avec une action d’usine qui permet de se connecter à Adobe Campaign Standard. La procédure de configuration est la suivante :

...
Pour chaque source de données, vous pouvez définir plusieurs groupes de champs ayant chacun une durée de mise en cache spécifique. Ces groupes vous permettent de choisir les champs à récupérer dans la source de données à utiliser dans vos parcours.

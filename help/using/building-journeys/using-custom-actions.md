...
Si vous utilisez une action personnalisée, les paramètres **[!UICONTROL Configuration d’URL]** et **[!UICONTROL Authentification]** définis dans l’écran de configuration des actions sont affichés en lecture seule (voir [](../action/about-custom-action-configuration.md)).
